...
import { Sparkles, ArrowUpRight, Code2, FolderKanban, Terminal } from "lucide-react";
...
export default function HomePage() {
  return (
    <div className="relative flex flex-1 flex-col items-center justify-center min-h-[calc(100vh-4.5rem)] overflow-hidden">
      ...
      <div className="pointer-events-none absolute -top-28 left-1/2 h-[600px] w-[600px] -translate-x-1/2 rounded-full bg-studio-cyan/15 blur-[160px] dark:bg-studio-cyan/20" />
      <div className="pointer-events-none absolute -bottom-28 right-1/4 h-[550px] w-[550px] rounded-full bg-studio-lime/10 blur-[170px] dark:bg-studio-lime/15" />
      <div className="pointer-events-none absolute top-1/3 -left-28 h-[480px] w-[480px] rounded-full bg-studio-purple/15 blur-[160px]" />
      ...
      {/* Hero Content Overlay (Engineered for Zero LCP Delay & Crystal-Clear Readability) */}
      <Container className="relative z-10 text-center pointer-events-none py-12 sm:py-16 md:py-20">
        {/* Status & Engineering Badge */}
        <FadeIn direction="up" delay={0.1}>
          <div className="inline-flex items-center gap-2.5 rounded-full border border-white/10 dark:border-white/10 bg-background/80 dark:bg-zinc-950/80 px-4 py-1.5 text-xs font-mono backdrop-blur-xl shadow-[0_0_25px_rgba(0,240,255,0.12)] pointer-events-auto hover:border-studio-cyan/50 transition-colors">
        ...
        {/* Primary Hero Title: Digital experiences, engineered with purpose */}
        <FadeIn direction="up" delay={0.2} className="mt-6 sm:mt-8 max-w-5xl mx-auto">
        ...
        <FadeIn direction="up" delay={0.3} className="mt-6 max-w-2xl mx-auto">
          <div className="rounded-2xl border border-white/10 dark:border-white/10 bg-background/70 dark:bg-zinc-950/75 p-4 sm:p-6 backdrop-blur-xl shadow-[0_8px_32px_rgba(0,0,0,0.35)]">
        ...
        <FadeIn direction="up" delay={0.5} className="mt-12 sm:mt-16">
